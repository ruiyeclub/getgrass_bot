...
async def get_proxy_list():
    # https://www.tyhttp.com/?invitation_code=8889627300
    url = ''
    ...
    if response.status_code == 200:
        ...
        for proxy in proxy_list:
            ip = proxy['ip']
            port = proxy['port']
            socks5_proxy_list.append("socks5://{}:{}".format(ip, port))
        # 输出结果
...
async def main():
    # TODO 修改user_id
    _user_id = '88b84946-cd56-4c32-9329-22e2591fa440'
    # TODO 修改代理列表
    socks5_proxy_list = await get_proxy_list()
